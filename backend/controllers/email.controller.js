...
const sendEmail = async (req, res) => {
  const { tips, roundNumber, name, toEmails, ccEmails, reCaptchaValue } = req.body;

  // Check if any params are blank

  response = await sendEmailService(tips, roundNumber, name, toEmails, ccEmails, reCaptchaValue);
